...
class Account extends PureComponent {
  ...
  get modalProps() {
    const { dispatch, account, loading, i18n } = this.props
    const { currentItem, modalVisible, modalType } = account
    ...
    return {
      ...
      title: `${
        modalType === 'create' ? i18n.t`Create Account` : i18n.t`Update Account`
      }`,
      centered: true,
      onOk: data => {
        dispatch({
